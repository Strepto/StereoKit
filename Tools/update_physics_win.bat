...
mkdir Debug_ARM64
cd Debug_ARM64
cmake -G "Visual Studio 17 2022" -A ARM64 -DCMAKE_BUILD_TYPE=Debug ../
cmake --build .
...
mkdir Release_ARM
cd Release_ARM
cmake -G "Visual Studio 17 2022" -A ARM -DCMAKE_BUILD_TYPE=Release ../
cmake --build . --config Release
...
mkdir Debug_ARM
cd Debug_ARM
cmake -G "Visual Studio 17 2022" -A ARM -DCMAKE_BUILD_TYPE=Debug ../
cmake --build .
